...
description: 목록·피드를 맨 위에서 아래로 당기면 새로고침하는 pull to refresh 제스처(당김 저항·스피너·복귀)를 구현한다. "당겨서 새로고침, 위에서 당기면 새로고침, 끌어내리면 다시 불러오기, 피드 당김 갱신, 끌어내려 리로드" 요청에 쓴다. 기존 적용분의 당김 임계값·저항 수정에도 쓴다.
---
