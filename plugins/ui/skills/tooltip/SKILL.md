---
name: tooltip
description: 호버·포커스 시 잠시 뒤 떠오르는 툴팁(tooltip) 말풍선을 구현한다 — 페이드+슬라이드 등장, 4방향 배치, Esc 닫기. "툴팁 컴포넌트, 말풍선 설명, 마우스 올리면 설명, 아이콘에 갖다 대면 도움말, 물음표 도움말 아이콘" 요청과 버튼·아이콘·용어에 짧은 보조 설명을 붙일 때 쓴다. 기존 적용분의 위치·지연 시간·색 수정에도 쓴다.
---
