...
description: 길게 누르면 항목이 살짝 떠오르고 뒤가 흐려지며 옆에 액션 메뉴가 나타나는 iOS식 미리보기 메뉴 구현 — 데스크톱은 우클릭으로 열림. "길게 눌러 메뉴, 롱프레스 메뉴, 꾹 누르면 메뉴, 홈 화면 아이콘처럼 떠오르는 메뉴, 우클릭 컨텍스트 메뉴, 사진 길게 눌러 옵션" 요청 시 반드시 이 스킬을 사용할 것. 기존 적용분의 누르는 시간·흐림 강도·메뉴 위치·항목 수정 요청도 포함.
---
