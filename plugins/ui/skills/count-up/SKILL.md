---
name: count-up
description: 숫자가 목표값까지 굴러 올라가는 카운트업(count up) 애니메이션을 구현한다 — 잔액·포인트·통계 숫자에 쓴다. "숫자 올라가는 효과, 카운트업, 잔액/포인트 애니메이션, 숫자 롤링, 금액 촤르륵 올라가게" 요청과 대시보드 지표·금액 표시 UI에 쓴다. 기존 적용분의 속도·천 단위 콤마 포맷 수정에도 쓴다.
---
