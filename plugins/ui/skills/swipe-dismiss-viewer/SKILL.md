...
description: 전체화면 이미지 뷰어를 끌어내려 닫는 제스처(swipe to dismiss)를 구현한다 — 사진을 아무 방향으로 끌면 손가락을 따라 작아지고 배경이 투명해지며, 놓으면 거리·속도로 판정해 썸네일 자리로 돌아가며 닫히거나 중앙으로 복귀한다. "끌어서 닫기, 사진 뷰어 드래그 닫기, 아래로 당겨 닫기, 이미지 뷰어" 요청에 쓴다. 기존 적용분의 닫힘 거리·속도 임계값 수정에도 쓴다.
---
