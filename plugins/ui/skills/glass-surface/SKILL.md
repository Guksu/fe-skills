---
name: glass-surface
description: 뒤 배경이 흐릿하게 비치는 반투명 유리판 글라스모피즘(glassmorphism) 카드·헤더·내비게이션 바를 구현한다. "글라스 UI, 유리 효과, 유리처럼 반투명한 헤더, 블러 카드, 뒤가 비치는 배경, backdrop-filter" 요청과 사진·그라데이션 위에 얹는 카드·상단 바에 쓴다. 기존 적용분의 흐림 정도·투명도·테두리·폴백 수정에도 쓴다.
---
