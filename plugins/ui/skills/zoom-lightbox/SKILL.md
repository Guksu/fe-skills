---
name: zoom-lightbox
description: 썸네일을 누르면 그 요소가 화면 가운데로 커지는 라이트박스(lightbox) 확대 전환을 구현한다. "라이트박스, 이미지 크게 보기, 썸네일 클릭하면 확대, 갤러리 사진 크게 보기, 이미지 확대 보기 전환" 요청과 갤러리·상세 이미지 UI에 쓴다. 기존 적용분의 확대 크기·속도 수정에도 쓴다.
---
